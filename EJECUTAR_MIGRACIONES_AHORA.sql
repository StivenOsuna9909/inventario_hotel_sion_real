-- ============================================
-- ⚠️ IMPORTANTE: Si recibes error "relation does not exist"
-- Usa el archivo SETUP_COMPLETO_DATABASE.sql en su lugar
-- ============================================
-- MIGRACIONES PARA SUPABASE (Solo si las tablas ya existen)
